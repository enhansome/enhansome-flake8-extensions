...
* [flake8-bugbear](https://github.com/PyCQA/flake8-bugbear) ⭐ 1,115 | 🐛 67 | 🌐 Python | 📅 2026-08-18 - Finding likely bugs and design problems in your program.
...
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 6 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [flake8-comprehensions](https://github.com/adamchainz/flake8-comprehensions) ⭐ 465 | 🐛 7 | 🌐 Python | 📅 2026-08-18 - Helps you write better list/set/dict comprehensions.
...
* [flake8-tidy-imports](https://github.com/adamchainz/flake8-tidy-imports) ⭐ 74 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - Extension that helps you write tidier imports.
...
* [flake8-pytest-style](https://github.com/m-burst/flake8-pytest-style) ⭐ 240 | 🐛 35 | 🌐 Python | 📅 2026-08-19 - Checks for common style issues or inconsistencies with pytest-based tests.
...
* [flake8-django-migrations](https://github.com/browniebroke/flake8-django-migrations) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-08-18 - Plugin to lint for backwards incompatible database migrations in Django.
...
* [flake8-isort](https://github.com/gforcada/flake8-isort) ⭐ 186 | 🐛 1 | 🌐 Python | 📅 2025-10-25 - Wrapper around [isort](https://github.com/PyCQA/isort) ⭐ 6,946 | 🐛 87 | 🌐 Python | 📅 2026-08-18.
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,806 | 🐛 302 | 🌐 Python | 📅 2026-08-19.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 13 | 🌐 Python | 📅 2023-09-13 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,223 | 🐛 259 | 🌐 Python | 📅 2026-08-04.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,711 | 🐛 1,082 | 🌐 Python | 📅 2026-08-18.
