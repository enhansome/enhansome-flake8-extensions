...
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,889 | 🐛 25 | 🌐 Python | 📅 2026-08-17 - The strictest and most opinionated Python linter ever.
* [flake8-bugbear](https://github.com/PyCQA/flake8-bugbear) ⭐ 1,115 | 🐛 66 | 🌐 Python | 📅 2026-08-11 - Finding likely bugs and design problems in your program.
...
* [dlint](https://github.com/dlint-py/dlint) ⭐ 177 | 🐛 23 | 🌐 Python | 📅 2026-01-07 - Tool for encouraging best coding practices and helping ensure Python code is secure.
* [flake8-pie](https://github.com/sbdchd/flake8-pie) ⚠️ Archived - Extension that implements misc. lints.
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 6 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [flake8-lazy](https://github.com/henryiii/flake8-lazy) ⭐ 22 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - Detect modules that can be lazy imported in Python 3.15+.
...
* [flake8-django-migrations](https://github.com/browniebroke/flake8-django-migrations) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-08-15 - Plugin to lint for backwards incompatible database migrations in Django.
...
* [flake8-isort](https://github.com/gforcada/flake8-isort) ⭐ 187 | 🐛 1 | 🌐 Python | 📅 2025-10-25 - Wrapper around [isort](https://github.com/PyCQA/isort) ⭐ 6,948 | 🐛 92 | 🌐 Python | 📅 2026-08-16.
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,804 | 🐛 306 | 🌐 Python | 📅 2026-08-10.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 13 | 🌐 Python | 📅 2023-09-13 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,222 | 🐛 260 | 🌐 Python | 📅 2026-08-04.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,712 | 🐛 1,084 | 🌐 Python | 📅 2026-08-16.
