...
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,913 | 🐛 13 | 🌐 Python | 📅 2026-09-24 - The strictest and most opinionated Python linter ever.
...
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 7 | 🐛 5 | 🌐 Python | 📅 2026-09-25 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [nitpick](https://github.com/andreoliwa/nitpick) ⭐ 411 | 🐛 57 | 🌐 Python | 📅 2026-09-25 - Enforce the same lint configuration (flake8, isort, mypy, pylint) across multiple Python projects.
...
* [flake8-type-checking](https://github.com/snok/flake8-type-checking) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-09-24 - Plugin lets you know which imports to move in or out of type-checking blocks.
...
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,851 | 🐛 282 | 🌐 Python | 📅 2026-09-24.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 14 | 🌐 Python | 📅 2026-09-07 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,281 | 🐛 258 | 🌐 Python | 📅 2026-09-21.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,726 | 🐛 1,027 | 🌐 Python | 📅 2026-09-24.
