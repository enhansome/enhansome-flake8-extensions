...
* [flake8-bugbear](https://github.com/PyCQA/flake8-bugbear) ⭐ 1,117 | 🐛 55 | 🌐 Python | 📅 2026-09-09 - Finding likely bugs and design problems in your program.
...
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 7 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [flake8-executable](https://github.com/xuhdev/flake8-executable) ⭐ 20 | 🐛 20 | 🌐 Python | 📅 2026-09-12 - Plugin for checking executable permissions and shebangs.
...
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,841 | 🐛 312 | 🌐 Python | 📅 2026-09-11.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 14 | 🌐 Python | 📅 2026-09-07 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,258 | 🐛 259 | 🌐 Python | 📅 2026-08-29.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,722 | 🐛 1,087 | 🌐 Python | 📅 2026-09-08.
