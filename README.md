...
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,895 | 🐛 13 | 🌐 Python | 📅 2026-08-31 - The strictest and most opinionated Python linter ever.
* [flake8-bugbear](https://github.com/PyCQA/flake8-bugbear) ⭐ 1,116 | 🐛 62 | 🌐 Python | 📅 2026-08-22 - Finding likely bugs and design problems in your program.
...
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 6 | 🐛 5 | 🌐 Python | 📅 2026-08-31 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [flake8-no-implicit-concat](https://github.com/10sr/flake8-no-implicit-concat) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - Report implicit string concatenation.
...
* [nitpick](https://github.com/andreoliwa/nitpick) ⭐ 413 | 🐛 57 | 🌐 Python | 📅 2026-08-27 - Enforce the same lint configuration (flake8, isort, mypy, pylint) across multiple Python projects.
...
* [flake8-django-migrations](https://github.com/browniebroke/flake8-django-migrations) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Plugin to lint for backwards incompatible database migrations in Django.
...
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,824 | 🐛 310 | 🌐 Python | 📅 2026-08-20.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 13 | 🌐 Python | 📅 2023-09-13 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,248 | 🐛 259 | 🌐 Python | 📅 2026-08-29.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,721 | 🐛 1,081 | 🌐 Python | 📅 2026-08-30.
