...
* [flake8-pytest-style](https://github.com/m-burst/flake8-pytest-style) ⭐ 241 | 🐛 35 | 🌐 Python | 📅 2026-09-14 - Checks for common style issues or inconsistencies with pytest-based tests.
...
* [flake8-future-annotations](https://github.com/tyleryep/flake8-future-annotations) ⭐ 15 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - Verifies Python 3.7+ files use `from __future__ import annotations`.
...
* [flake8-scrapy](https://github.com/stummjr/flake8-scrapy) ⭐ 22 | 🐛 95 | 🌐 Python | 📅 2026-09-07 - Plugin to catch common issues on Scrapy spiders.
* [flake8-django-migrations](https://github.com/browniebroke/flake8-django-migrations) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Plugin to lint for backwards incompatible database migrations in Django.
...
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,844 | 🐛 318 | 🌐 Python | 📅 2026-09-11.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 14 | 🌐 Python | 📅 2026-09-07 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,259 | 🐛 259 | 🌐 Python | 📅 2026-08-29.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,723 | 🐛 1,027 | 🌐 Python | 📅 2026-09-14.
