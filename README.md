...
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,889 | 🐛 25 | 🌐 Python | 📅 2026-08-18 - The strictest and most opinionated Python linter ever.
* [flake8-bugbear](https://github.com/PyCQA/flake8-bugbear) ⭐ 1,115 | 🐛 66 | 🌐 Python | 📅 2026-08-18 - Finding likely bugs and design problems in your program.
...
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 6 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [flake8-secure-coding-standard](https://github.com/Takishima/flake8-secure-coding-standard) ⭐ 5 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - Enforce some secure coding standards for Python. <!-- TODO(@orsinium): move into 'All-in-one' when grows -->
...
* [flake8-too-many](https://github.com/queensferryme/flake8-too-many) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Plugin that prevents you from writing 'too many' bad codes.
...
* [nitpick](https://github.com/andreoliwa/nitpick) ⭐ 413 | 🐛 57 | 🌐 Python | 📅 2026-08-17 - Enforce the same lint configuration (flake8, isort, mypy, pylint) across multiple Python projects.
...
* [flake8-datetime-import](https://github.com/marcgibbons/flake8-datetime-import) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - Enforce importing `datetime as dt` and `time as tm`.
...
* [flake8-future-annotations](https://github.com/tyleryep/flake8-future-annotations) ⭐ 15 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - Verifies Python 3.7+ files use `from __future__ import annotations`.
...
* [flake8-isort](https://github.com/gforcada/flake8-isort) ⭐ 186 | 🐛 1 | 🌐 Python | 📅 2025-10-25 - Wrapper around [isort](https://github.com/PyCQA/isort) ⭐ 6,948 | 🐛 90 | 🌐 Python | 📅 2026-08-16.
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,803 | 🐛 305 | 🌐 Python | 📅 2026-08-17.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 13 | 🌐 Python | 📅 2023-09-13 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,221 | 🐛 259 | 🌐 Python | 📅 2026-08-04.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,712 | 🐛 1,080 | 🌐 Python | 📅 2026-08-17.
