...
* [flake8-bugbear](https://github.com/PyCQA/flake8-bugbear) ⭐ 1,115 | 🐛 64 | 🌐 Python | 📅 2026-08-11 - Finding likely bugs and design problems in your program.
...
* [flake8-simplify](https://github.com/MartinThoma/flake8-simplify) ⭐ 194 | 🐛 57 | 🌐 Python | 📅 2026-07-21 - Plugin that helps you to simplify code.
* [dlint](https://github.com/dlint-py/dlint) ⭐ 179 | 🐛 23 | 🌐 Python | 📅 2026-01-07 - Tool for encouraging best coding practices and helping ensure Python code is secure.
* [flake8-pie](https://github.com/sbdchd/flake8-pie) ⚠️ Archived - Extension that implements misc. lints.
* [flake8-tergeo](https://github.com/SAP/flake8-tergeo) ⭐ 6 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Adds many new rules to improve your code quality and brings a curated and actively maintained list of other plugins including flake8-bugbear.
...
* [flake8-string-format](https://github.com/xZise/flake8-string-format) ⭐ 20 | 🐛 12 | 🌐 Python | 📅 2026-08-01 - Check that indexed parameters are used in strings.
...
* [flake8-secure-coding-standard](https://github.com/Takishima/flake8-secure-coding-standard) ⭐ 5 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - Enforce some secure coding standards for Python. <!-- TODO(@orsinium): move into 'All-in-one' when grows -->
...
* [flake8-comprehensions](https://github.com/adamchainz/flake8-comprehensions) ⭐ 465 | 🐛 7 | 🌐 Python | 📅 2026-08-13 - Helps you write better list/set/dict comprehensions.
...
* [flake8-obey-import-goat](https://github.com/Melevir/flake8-obey-import-goat) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2023-05-17 - Allows to forbid specific imports.
...
* [tryceratops](https://github.com/guilatrova/tryceratops) ⭐ 448 | 🐛 10 | 🌐 Python | 📅 2024-10-30 - Prevent exception handling antipatterns.
...
* [flake8-too-many](https://github.com/queensferryme/flake8-too-many) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-10 - Plugin that prevents you from writing 'too many' bad codes.
...
* [flake8-logging](https://github.com/adamchainz/flake8-logging) ⭐ 86 | 🐛 15 | 🌐 Python | 📅 2026-08-13 - Reports issues in using the standard library logging module.
...
* [flake8-debugger](https://github.com/JBKahn/flake8-debugger) ⭐ 43 | 🐛 2 | 🌐 Python | 📅 2022-04-30 - Report debug statements (`pdb`, `ipdb`).
* [flake8-no-pep420](https://github.com/adamchainz/flake8-no-pep420) ⭐ 29 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Report implicit namespace packages.
...
* [cohesion](https://github.com/mschwager/cohesion#flake8-support) ⭐ 279 | 🐛 8 | 🌐 Python | 📅 2024-12-09 - Extension for measuring Python class cohesion.
...
* [flake8-annotations-complexity](https://github.com/best-doctor/flake8-annotations-complexity) ⭐ 50 | 🐛 4 | 🌐 Python | 📅 2025-03-04 - Plugin to validate annotations complexity.
* [flake8-functions](https://github.com/best-doctor/flake8-functions) ⭐ 50 | 🐛 9 | 🌐 Python | 📅 2026-04-13 - Plugin for validation of function parameters (length, complexity, etc).
* [flake8-expression-complexity](https://github.com/best-doctor/flake8-expression-complexity) ⭐ 33 | 🐛 9 | 🌐 Python | 📅 2022-03-19 - Plugin to validate expressions complexity.
...
* [pydoclint](https://github.com/jsh9/pydoclint) ⭐ 220 | 🐛 29 | 🌐 Python | 📅 2026-07-03 - A Python docstring linter that checks arguments, returns, yields, and raises sections.
...
* [nitpick](https://github.com/andreoliwa/nitpick) ⭐ 413 | 🐛 56 | 🌐 Python | 📅 2026-08-13 - Enforce the same lint configuration (flake8, isort, mypy, pylint) across multiple Python projects.
* [yesqa](https://github.com/asottile/yesqa) ⭐ 264 | 🐛 0 | 🌐 Python | 📅 2026-07-15 - A tool to automatically remove unnecessary `# noqa` comments.
...
* [flake8-import-order](https://github.com/PyCQA/flake8-import-order) ⭐ 281 | 🐛 14 | 🌐 Python | 📅 2026-08-11 - Include checks import order against various Python Style Guides.
...
* [flake8-tidy-imports](https://github.com/adamchainz/flake8-tidy-imports) ⭐ 74 | 🐛 5 | 🌐 Python | 📅 2026-08-13 - Extension that helps you write tidier imports.
* [flake8-lazy](https://github.com/henryiii/flake8-lazy) ⭐ 21 | 🐛 3 | 🌐 Python | 📅 2026-08-13 - Detect modules that can be lazy imported in Python 3.15+.
...
* [flake8-datetime-import](https://github.com/marcgibbons/flake8-datetime-import) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Enforce importing `datetime as dt` and `time as tm`.
...
* [flake8-pytest-style](https://github.com/m-burst/flake8-pytest-style) ⭐ 240 | 🐛 34 | 🌐 Python | 📅 2026-08-13 - Checks for common style issues or inconsistencies with pytest-based tests.
...
* [flake8-future-annotations](https://github.com/tyleryep/flake8-future-annotations) ⭐ 15 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - Verifies Python 3.7+ files use `from __future__ import annotations`.
...
* [flake8-scrapy](https://github.com/stummjr/flake8-scrapy) ⭐ 22 | 🐛 96 | 🌐 Python | 📅 2026-07-07 - Plugin to catch common issues on Scrapy spiders.
* [flake8-django-migrations](https://github.com/browniebroke/flake8-django-migrations) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - Plugin to lint for backwards incompatible database migrations in Django.
...
* [flake8-isort](https://github.com/gforcada/flake8-isort) ⭐ 187 | 🐛 1 | 🌐 Python | 📅 2025-10-25 - Wrapper around [isort](https://github.com/PyCQA/isort) ⭐ 6,949 | 🐛 89 | 🌐 Python | 📅 2026-08-11.
* [flake8-black](https://github.com/peterjc/flake8-black) ⭐ 167 | 🐛 4 | 🌐 Python | 📅 2026-08-03 - Wrapper around [black](https://github.com/psf/black) ⭐ 41,802 | 🐛 302 | 🌐 Python | 📅 2026-08-10.
* [flake8-bandit](https://github.com/tylerwince/flake8-bandit) ⭐ 116 | 🐛 13 | 🌐 Python | 📅 2023-09-13 - Wrapper around [bandit](https://github.com/PyCQA/bandit) ⭐ 8,213 | 🐛 258 | 🌐 Python | 📅 2026-08-04.
* [flake8-pylint](https://github.com/orsinium-labs/flake8-pylint) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-10-07 - Wrapper around [pylint](https://github.com/pylint-dev/pylint) ⭐ 5,712 | 🐛 1,084 | 🌐 Python | 📅 2026-08-13.
