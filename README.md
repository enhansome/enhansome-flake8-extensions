...
* [nitpick](https://github.com/andreoliwa/nitpick) ⭐ 411 | 🐛 58 | 🌐 Python | 📅 2026-09-25 - Enforce the same lint configuration (flake8, isort, mypy, pylint) across multiple Python projects.
